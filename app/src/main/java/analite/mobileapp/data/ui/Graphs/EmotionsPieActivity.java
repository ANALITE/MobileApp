...
public class EmotionsPieActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = (ImageButton) findViewById(R.id.pie_back);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EmotionsPieActivity.this.onBackPressed();
            }
        });
...
//            }
    ...
    private SpannableString generateCenterSpannableText() {
        ...
        SpannableString s = new SpannableString("Emotions Chart\ndeveloped by Analite Lineup");
