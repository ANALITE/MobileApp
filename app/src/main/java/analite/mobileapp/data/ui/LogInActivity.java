...
public class LogInActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //dummy_users = getIntent().getParcelableExtra("UserRepo");
        dummy_users = new SimpleUserRepository();
        dummy_users.createUser("TransMilenio","transmilenio@hotmail.com","transmilenio");
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            User existed_user = dummy_users.findUserByEmail(mEmail);
            if (existed_user!=null){
                satisfy_login = existed_user.getPassword().equals(mPassword);
            }
