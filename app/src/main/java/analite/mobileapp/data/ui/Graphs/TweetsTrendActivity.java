...
import analite.mobileapp.data.entities.DemoBase;
import androidx.core.content.ContextCompat;

public class TweetsTrendActivity extends DemoBase implements OnSeekBarChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = (ImageButton) findViewById(R.id.line_back);

        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TweetsTrendActivity.this.onBackPressed();
            }
        });
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        String[] dataNames = new String[]{"Positive","Negative","Neutral"};
        String[] dataDates = new String[]{"Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov"};
        ...
        for (int z = 0; z < 3; z++) {
            ...
            LineDataSet d = new LineDataSet(values, dataNames[z]);
            d.setLineWidth(2.5f);
        ...
        xAxis.setValueFormatter(new MyXAxisValueFormatter(dataDates));
        chart.setData(data);
        chart.invalidate();
    }
    ...
    private class MyXAxisValueFormatter implements IAxisValueFormatter {
        ...
        public MyXAxisValueFormatter(String[] dataDates) {
            this.mValues = dataDates;
        }
